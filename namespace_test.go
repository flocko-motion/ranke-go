...
// Foundation unit tests for the reserved-namespace + charset rules (§5.1).
// The system owns a reserved namespace marked by a leading "." (the
// wire-alias namespace). User-supplied names must stay out of it. Beyond
// that, each namespace has a charset:
//
